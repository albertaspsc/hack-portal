...
export default function ScanType({ name, onClick }: ScanTypeProps) {
  return (
    <div
      className="md:p-4 p-2 cursor-pointer m-3 bg-secondary rounded-lg text-primary hover:bg-primaryDark hover:text-secondary transition duration-300 ease-in-out h-min"
      onClick={onClick}
    >
